    ...
    <div class="col-md-offset-3 col-md-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:30px">
                ...
                <form action="{{ url('inicio/confirmacion/'.$infoEdit->id) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <!-- -->
                        <input readonly="readonly" type="text" name="titulo" id="titulo" class="form-control" value="{{$infoEdit->titulo}}" required>

                        <label for="texto">Texto Principal del Post</label>
                        <!-- -->
                        <textarea readonly="readonly" id="texto" name="texto" cols="44" class="form-control" required>{{$infoEdit->texto}}</textarea>
